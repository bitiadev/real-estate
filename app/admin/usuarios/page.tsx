  ...
  return (
    <div className="px-4 md:px-8 py-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold mb-1 text-center">Gestión de Usuarios</h1>
          <p className="text-gray-500 text-center">Administra los usuarios con acceso al sistema</p>
        </div>
